    ...
    return (
        <div style={{ 
            ...
            <div ref={scene1}>
                ...
                <hr />
                <p>Yeonmi Park was born on the 4th October 1993, in Hyesan, North Korea. Her Mother was a nurse and her Father was a civil servant. Yeonmi was born a year before the North Korean famine of 1994-1998, a result of the collapse of the Soviet Union, which could no longer support the North Korean regime. Yeonmi would grow up with mass starvation all around her, seeing corpses on the streets every day. It is estimated that there were between 240,000 to 3.5 million deaths caused by the famine, in which people mostly died from hunger or infection. This famine is also referred to as the 'Arduous March'. Yeonmi and her family would survive these years by living on a diet of grasshoppers, dragonflies, and other insects. As well as tree bark, plants and flowers. Some North Koreans resorted to cannibalism to survive.</p>
                    
                <p>As well as suffering from the famine, Yeonmi, like many other North Koreans, grew up in absolute poverty. Yeonmi’s family were considered of the lowest class, due to North Korea's ‘guilty by association’ policy. This policy condemns 3 to 8 generations of a family, if one family member is found guilty of a crime. In Yeonmi’s family’s case, this was because her great grandfather was a landowner before the North Korean regime.</p>
                
                <p className='facts'>Crimes as small as accidentally ripping a newspaper with Kim Jong-un's face on it, can mean your families next three generations will go to a concentration camp.</p> 
            ...
            <div ref={scene2}>
                ...
                <hr />
                <p>Yeonmi’s Father, Park Jin-sik would trade sugar, spices and metals on the black market – this is a highly illegal activity in North Korea as North Koreans are forbidden to have any personal possessions or property. When Yeonmi was 8 years old, her Father was discovered trading, and sent to a prison camp with an 11 year sentence. In order to support the Yeonmi and her older sister, Yeonmi’s Mother would go away for months to find work, leaving Yeonmi and her sister alone.</p>

                <p className='facts'>Prison camps in North Korea involve unbearable labour. A lot of inmates die within the first three months of their sentences. In 2010, the UN did three year investigation and the only resemblance to these prison camps is the holocaust.</p> 
                ...
                <p className='facts'>$1.90 a day is line between poverty by UN. North Koreans were making this in a month.</p>
                <p className='facts'>North Korea also has Kwalliso camps, which are different to their prison. Many inmates are born in these camps, and will spend their whole lives there. This is a result of the 'guilt by association' policy. These camps are influenced by Stalinist and Maoist camps.</p>
            ...
            <div ref={scene3}>
                ...
                <p>Yeonmi’s trafficker could no longer afford to feed Yeonmi’s and her Mother due to his gambling addictions, and he eventually let them go. At the age of 13, Yeonmi would be forced to work in online chatrooms to earn money. Yeonmi was later helped by a group of Chinese Christians, who offered to help Yeonmi and her Mother relocate to Mongolia. Yeonmi would have to prove her faith to the missionaries by memorising bible verses and fasting.</p>
            ...
            <div ref={scene4}>
                ...
                <p>Once the group reached Mongolia, they were put in a holding camp.  Mongolian soldiers would trick the defectors into thinking they were going to be deported back to North Korea, Yeonmi remembers a group of defectors who came after her, when a woman poisoned herself as a result of this.
                ...
                <p className='facts'>as it was common for North Korea to send spies to assassinate real defectors, or find information about defectors so their family members could be punished.</p>
            </div>
            <div ref={scene5}>
                ...
                <p>Yeonmi and her Mother then lived in public housing in the South Korean countryside. Yeonmi spent the next year studying and got her high school GED equivelant within just one year. Yeonmi had an educational equivalent grade of a 7 year old when she arrived in South Korea. Yeonmi then applied for university to study criminal justice in Seoul. During her time in Seoul, Yeonmi was asked to take part in an entertainment show, cast as the 'North Korean Paris Hilton'. Yeonmi was convinced to do this, only because the producers told her she may find her sister, who was still in China. Yeonmi later found her sister because of this show.</p> 
            ...
            <div ref={scene6}>
                ...
                <p>Through university, Yeonmi attended a youth leaders conference in Ireland. Yeonmi was a delegate speaker at this conference, and spoke of her life experiences. Yeonmi was then approached by Penguin with a book offer, Yeonmi then moved to New York to work on her book, however Yeonmi wanted to continue studying during this time. Yeonmi attended New York Columbia university for the next four years.</p>
                <p>While at Columbia university, Yeonmi became very pessimistic about the western world. Yeonmi was imposed with censorship and ideological teachings at Columbia university, as well as experiencing dangerous trends emerging such as group guilt, and guilt by association.</p>
                <p>Yeonmi Park now spends her time raising awareness of the North Korean regime, and its enablement by the Chinese Communist Party, as well as warning of the dangerous path that western culture is heading.</p>  
            </div>
        </div>
)
}
