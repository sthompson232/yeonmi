...
export const Finish = () => {
    ...
    return (
        <div className='landing'>
            ...
            <br />
            <h2 className='end-text' ref={text3}>To learn more about Yeonmi Park and her life, visit her YouTube channel <a target="_blank" rel="noreferrer" style={{ textDecoration: 'none', color: '#ffffff' }} href="https://www.youtube.com/channel/UCpQu57KgT7gOoLCAu3FFQsA"><u>Voice of North Korea by Yeonmi Park</u></a></h2>
            <br />
            ...
            <h3 className='end-text' ref={credits}><i>Website and music created by <a target="_blank" rel="noreferrer" style={{ textDecoration: 'none', color: '#ffffff' }} href="https://www.samthompson.io"><u>Sam Thompson</u></a></i></h3>
        </div>
    )
}